...
class wp_version:
    ...
    def __retrieve_package_md5(self, package_version: str) -> str:
        ...
        # 请求Wordpress官网的文件校验值
        package_md5 = requests.get('https://cn.wordpress.org/wordpress-{}-zh_CN.zip.md5'.format(package_version)).text
    ...
    def download_package(self, package_version: str) -> str:
        ...
        # 安装包下载URL
        download_url = 'https://cn.wordpress.org/wordpress-{}-zh_CN.zip'.format(package_version)
        try:
