...
class Environment(object):
    ...
    def __init__(self, project_name: str, python_path: str, project_path: str, user: str,
    ...
    def form_project_conf(cls, project_config: dict) -> Union["Environment", str]:
        ...
        python_path: str = project_config.get("vpath", None)
        project_path: str = project_config.get("path", None)
        env_list = project_config.get("env_list", [])
        env_file = project_config.get("env_file", "")
        project_name = project_config.get("pjname", None)
        ...
        return cls(project_name, python_path, project_path, user, env_list, env_file)
    ...
    def shell_env(self) -> str:
        ...
        res_env_list.append('export PATH="{}:${{PATH}}"'.format(self.python_path))
...
class PythonService(object):
    ...
    def from_config(cls, config: dict,
        ...
        command: str = config.get('command', None)
